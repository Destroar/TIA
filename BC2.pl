...
imprimir_informacoes(a1) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            ...
            Lista), nl,
    write('Informa��es para o perfil '), write('a1'), write(':'), nl,
...
imprimir_informacoes(a2) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, entre3a12meses, _, Prescricao, Dose, Vezes, Condicao),
             doente(pneumonia, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('a2'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(a3) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, entre1a4anos, _, Prescricao, Dose, Vezes, Condicao),
             doente(pneumonia, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('a3'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(a4) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, entre5a9anos, _, Prescricao, Dose, Vezes, Condicao),
             doente(pneumonia, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('a4'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(a5) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, entre10a13anos, _, Prescricao, Dose, Vezes, Condicao),
             doente(pneumonia, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('a5'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(a6) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, entre14a17anos, _, Prescricao, Dose, Vezes, Condicao),
             doente(pneumonia, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('a6'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(a7) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, mais18anos, _, Prescricao, Dose, Vezes, Condicao),
             doente(pneumonia, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('a7'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(a8) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, _, mais40kg, Prescricao, Dose, Vezes, Condicao),
             doente(pneumonia, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('a8'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(b1) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            ...
            Lista), nl,
    write('Informa��es para o perfil '), write('b1'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(b2) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            ...
            Lista), nl,
    write('Informa��es para o perfil '), write('b2'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(c1) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            ...
            Lista), nl,
    write('Informa��es para o perfil '), write('c1'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(c2) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, _, menos6kg, Prescricao, Dose, Vezes, Condicao),
             doente(amigdalite, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('c2'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(c3) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, menos3meses, _, Prescricao, Dose, Vezes, Condicao),
             doente(amigdalite, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('c3'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(c4) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, entre3a12meses, _, Prescricao, Dose, Vezes, Condicao),
             doente(amigdalite, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('c4'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(c5) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, entre1a4anos, _, Prescricao, Dose, Vezes, Condicao),
             doente(amigdalite, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('c5'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(c6) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, entre5a9anos, _, Prescricao, Dose, Vezes, Condicao),
             doente(amigdalite, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('c6'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(c7) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, entre10a13anos, _, Prescricao, Dose, Vezes, Condicao),
             doente(amigdalite, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('c7'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(c8) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, entre14a17anos, _, Prescricao, Dose, Vezes, Condicao),
             doente(amigdalite, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('c8'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(c9) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, mais18anos, _, Prescricao, Dose, Vezes, Condicao),
             doente(amigdalite, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('c9'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(d1) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, _, mais40kg, Prescricao, Dose, Vezes, Condicao),
             doente(otite, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('d1'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(d2) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, _, menos6kg, Prescricao, Dose, Vezes, Condicao),
             doente(otite, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('d2'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(d3) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, menos3meses, _, Prescricao, Dose, Vezes, Condicao),
             doente(otite, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('d3'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(d4) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, entre3a12meses, _, Prescricao, Dose, Vezes, Condicao),
             doente(otite, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('d4'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(d5) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, entre1a4anos, _, Prescricao, Dose, Vezes, Condicao),
             doente(otite, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('d5'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(d6) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, entre5a9anos, _, Prescricao, Dose, Vezes, Condicao),
             doente(otite, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('d6'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(d7) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, entre10a13anos, _, Prescricao, Dose, Vezes, Condicao),
             doente(otite, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('d7'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(d8) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, entre14a17anos, _, Prescricao, Dose, Vezes, Condicao),
             doente(otite, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('d8'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(d9) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, mais18anos, _, Prescricao, Dose, Vezes, Condicao),
             doente(otite, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('d9'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(e1) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, mais18anos, _, Prescricao, Dose, Vezes, Condicao),
             doente(zona, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('e1'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(f1) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            ...
            Lista), nl,
    write('Informa��es para o perfil '), write('f1'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(f2) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, entre5a9anos, _, Prescricao, Dose, Vezes, Condicao),
             doente(alergiaAlimentar, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('f2'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(f3) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, entre10a13anos, _, Prescricao, Dose, Vezes, Condicao),
             doente(alergiaAlimentar, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('f3'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(f4) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, entre14a17anos, _, Prescricao, Dose, Vezes, Condicao),
             doente(alergiaAlimentar, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('f4'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(f5) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, mais18anos, _, Prescricao, Dose, Vezes, Condicao),
             doente(alergiaAlimentar, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('f5'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(g1) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            ...
            Lista), nl,
    write('Informa��es para o perfil '), write('g1'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(g2) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, entre5a9anos, _, Prescricao, Dose, Vezes, Condicao),
             doente(alergiaRespiratoria, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('g2'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(g3) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, entre10a13anos, _, Prescricao, Dose, Vezes, Condicao),
             doente(alergiaRespiratoria, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('g3'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(g4) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, entre14a17anos, _, Prescricao, Dose, Vezes, Condicao),
             doente(alergiaRespiratoria, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('g4'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(g5) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, mais18anos, _, Prescricao, Dose, Vezes, Condicao),
             doente(alergiaRespiratoria, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('g5'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(h1) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            ...
            Lista), nl,
    write('Informa��es para o perfil '), write('h1'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(h2) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, entre3a12meses, _, Prescricao, Dose, Vezes, Condicao),
             doente(bronquite, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('h2'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(h3) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, entre1a4anos, _, Prescricao, Dose, Vezes, Condicao),
             doente(bronquite, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('h3'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(h4) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, entre5a9anos, _, Prescricao, Dose, Vezes, Condicao),
             doente(bronquite, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('h4'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(h5) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, entre10a13anos, _, Prescricao, Dose, Vezes, Condicao),
             doente(bronquite, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('h5'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(h6) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, entre14a17anos, _, Prescricao, Dose, Vezes, Condicao),
             doente(bronquite, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('h6'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(h7) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, mais18anos, _, Prescricao, Dose, Vezes, Condicao),
             doente(bronquite, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('h7'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(i1) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            ...
            Lista), nl,
    write('Informa��es para o perfil '), write('i1'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(i2) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, entre5a9anos, _, Prescricao, Dose, Vezes, Condicao),
             doente(enxaqueca, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('i2'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(i3) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, entre10a13anos, _, Prescricao, Dose, Vezes, Condicao),
             doente(enxaqueca, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('i3'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(i4) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, entre14a17anos, _, Prescricao, Dose, Vezes, Condicao),
             doente(enxaqueca, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('i4'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(i5) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, entre3a12meses, _, Prescricao, Dose, Vezes, Condicao),
             doente(enxaqueca, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('i5'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(i6) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, entre1a4anos, _, Prescricao, Dose, Vezes, Condicao),
             doente(enxaqueca, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('i6'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(i7) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, mais18anos, _, Prescricao, Dose, Vezes, Condicao),
             doente(enxaqueca, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('i7'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(j1) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, mais18anos, _, Prescricao, Dose, Vezes, Condicao),
             doente(gripe, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('j1'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(j2) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, entre3a12meses, _, Prescricao, Dose, Vezes, Condicao),
             doente(gripe, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('j2'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(j3) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, entre1a4anos, _, Prescricao, Dose, Vezes, Condicao),
             doente(gripe, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('j3'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(j4) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, entre5a9anos, _, Prescricao, Dose, Vezes, Condicao),
             doente(gripe, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('j4'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(j5) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            ...
            doente(gripe, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('j5'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(j6) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, entre14a17anos, _, Prescricao, Dose, Vezes, Condicao),
             doente(gripe, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('j6'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(k1) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            ...
            Lista), nl,
    write('Informa��es para o perfil '), write('k1'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(k2) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, entre14a17anos, _, Prescricao, Dose, Vezes, Condicao),
             doente(artrite, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('k2'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(k3) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, mais18anos, _, Prescricao, Dose, Vezes, Condicao),
             doente(artrite, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('k3'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(k4) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, entre3a12meses, _, Prescricao, Dose, Vezes, Condicao),
             doente(artrite, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('k4'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(k5) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, entre1a4anos, _, Prescricao, Dose, Vezes, Condicao),
             doente(artrite, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('k5'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(k6) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, entre5a9anos, _, Prescricao, Dose, Vezes, Condicao),
             doente(artrite, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('k6'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(k7) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, entre10a13anos, _, Prescricao, Dose, Vezes, Condicao),
             doente(artrite, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('k7'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(l1) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            ...
            Lista), nl,
    write('Informa��es para o perfil '), write('l1'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(l2) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, entre10a13anos, _, Prescricao, Dose, Vezes, Condicao),
             doente(sinusite, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('l2'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(l3) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, entre14a17anos, _, Prescricao, Dose, Vezes, Condicao),
             doente(sinusite, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('l3'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(l4) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, mais18anos, _, Prescricao, Dose, Vezes, Condicao),
             doente(sinusite, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('l4'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(l5) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, entre3a12meses, _, Prescricao, Dose, Vezes, Condicao),
             doente(sinusite, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('l5'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(l6) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, entre1a4anos, _, Prescricao, Dose, Vezes, Condicao),
             doente(sinusite, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('l6'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(m1) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            ...
            Lista), nl,
    write('Informa��es para o perfil '), write('m1'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(n1) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            ...
            Lista), nl,
    write('Informa��ess para o perfil '), write('n1'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(n2) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, entre10a13anos, _, Prescricao, Dose, Vezes, Condicao),
             doente(infecaoUrinaria, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('n2'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(n3) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, entre5a9anos, _, Prescricao, Dose, Vezes, Condicao),
             doente(infecaoUrinaria, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('n3'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(n4) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, entre1a4nos, _, Prescricao, Dose, Vezes, Condicao),
             doente(infecaoUrinaria, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('n4'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(n5) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, entre3a12meses, _, Prescricao, Dose, Vezes, Condicao),
             doente(infecaoUrinaria, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('n5'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(n6) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, menos3meses, _, Prescricao, Dose, Vezes, Condicao),
             doente(infecaoUrinaria, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('n6'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_informacoes(n7) :-
    findall((Doenca, Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao),
            (medicamento(Doenca, _, Tipo, Medicamento, _, menos6kg, Prescricao, Dose, Vezes, Condicao),
             doente(infecaoUrinaria, Doenca)),
            Lista), nl,
    write('Informa��es para o perfil '), write('n7'), write(':'), nl,
    imprimir_lista(Lista).
...
imprimir_lista([(Doenca,Tipo, Medicamento, Prescricao, Dose, Vezes, Condicao) | Resto]) :-
    ...
    write('Prescri��o: '), write(Prescricao),nl,
    write('Dose: '), write(Dose),nl,
    write('Vezes: '), write(Vezes),nl,
    write('Condi��o: '), write(Condicao), nl,

...
continuacao1:-
    ...
    write('|2-Nao                                                                                                     |'),nl,
    read(OPDC),
        ((OPDC == 1), assert(fact(dor_cabeca)),continuacao29;
         (OPDC == 2), continuacao2).
...
continuacao29:-
    ...
    write('|2-Nao                                                                                                     |'),nl,
    read(OPDU),
        ((OPDU == 1), assert(fact(dificuldade_em_urinar)),continuacao2;
         (OPDU == 2), continuacao2).
...
continuacao3:-
    write('|                                                                                                          |'),nl,
    write('|Tem tosse com expetoracao?                                                                                |'),nl,
    write('|1-Sim                                                                                                     |'),nl,
    write('|2-Nao                                                                                                     |'),nl,
    read(OPTE),
        ((OPTE == 1), assert(fact(tosse_expetoracao)),continuacao47;
         (OPTE == 2), continuacao4).
...
continuacao47:-
    ...
    write('|2-Nao                                                                                                     |'),nl,
    read(OPDP),
        ((OPDP == 1), assert(fact(dor_peito)),continuacao4;
         (OPDP == 2), continuacao4).
...
continuacao5:-
    ...
    write('|2-Nao                                                                                                     |'),nl,
    read(OPMEG),
        ((OPMEG == 1), assert(fact(mal_estar_geral)),continuacao54;
...
continuacao54:-
    ...
    write('|2-Nao                                                                                                     |'),nl,
    read(OPCAO),
        ((OPCAO == 1), assert(fact(comichao)),continuacao35;
...
continuacao35:-
    ...
    write('|2-Nao                                                                                                     |'),nl,
    read(OPCB),
        ((OPCB == 1), assert(fact(coceira_na_boca)),continuacao45;
...
continuacao45:-
    ...
    write('|2-Nao                                                                                                     |'),nl,
    read(OPCNOG),
        ((OPCNOG == 1), assert(fact(coceira_nariz_olhos_garganta)),continuacao28;
...
continuacao28:-
    ...
    write('|2-Nao                                                                                                     |'),nl,
    read(OPEC),
        ((OPEC == 1), assert(fact(erupcoes_cutaneas)),continuacao6;
         (OPEC == 2), continuacao6).
...
continuacao9:-
    ...
    write('|2-Nao                                                                                                     |'),nl,
    read(OPDO),
        ((OPDO == 1), assert(fact(dor_ouvido)),continuacao24;
...
continuacao24:-
    ...
    write('|2-Nao                                                                                                     |'),nl,
    read(OPDD),
        ((OPDD == 1), assert(fact(dificuldade_em_dormir)),continuacao26;
...
continuacao27:-
    ...
    write('|2-Nao                                                                                                     |'),nl,
    read(OPFAT),
        ((OPFAT == 1), assert(fact(falta_apetite)),continuacao10;
...
continuacao13:-
    ...
    write('|2-Nao                                                                                                     |'),nl,
    read(OPFA),
        ((OPFA == 1), assert(fact(falta_ar)),continuacao15;
...
continuacao16:-
    ...
    write('|2-Nao                                                                                                     |'),nl,
    read(OPOV),
        ((OPOV == 1), assert(fact(olhos_vermelhos)),continuacao23;
...
continuacao23:-
    ...
    write('|2-Nao                                                                                                     |'),nl,
    read(OPDE),
        ((OPDE == 1), assert(fact(dificuldade_engolir)),continuacao31;
...
continuacao34:-
    ...
    write('|2-Nao                                                                                                     |'),nl,
    read(OPDL),
        ((OPDL == 1), assert(fact(dor_lombar)),continuacao37;
...
continuacao44:-
    ...
    write('|2-Nao                                                                                                     |'),nl,
    read(OPT),
        ((OPT == 1), assert(fact(tonturas)),continuacao48;
         (OPT == 2), continuacao48).
...
continuacao48:-
    ...
    write('|2-Nao                                                                                                     |'),nl,
    read(OPFC),
        ((OPFC == 1), assert(fact(formigamento_corpo)),continuacao58;
...
continuacao58:-
    ...
    write('|2-Nao                                                                                                     |'),nl,
    read(OPIP),
        ((OPIP == 1), assert(fact(inchaco_palpebra)),continuacao56;
...
continuacao56:-
    ...
    write('|2-Nao                                                                                                     |'),nl,
    read(OPSAO),
        ((OPSAO == 1), assert(fact(sensacao_areia)),continuacao59;
...
continuacao59:-
    ...
    write('|2-Nao                                                                                                     |'),nl,
    read(OPCN),
        ((OPCN == 1), assert(fact(congestao_nasal)),continuacao46;
...
continuacao46:-
    ...
    write('|2-Nao                                                                                                     |'),nl,
    read(OPNV),
        ((OPNV == 1), assert(fact(nariz_vermelho)),continuacao60;

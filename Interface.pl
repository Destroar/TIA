...
continuacao21:-
    write('|                                                                                                          |'),nl,
    write('|Tem uma sensacao de algodao dentro da boca?                                                               |'),nl,
    write('|1-Sim                                                                                                     |'),nl,
    write('|2-Nao                                                                                                     |'),nl,
    read(OPSADB),
...
continuacao22:-
    write('|                                                                                                          |'),nl,
    write('|Tem uma camada esbranquicada na boca?                                                                     |'),nl,
    write('|1-Sim                                                                                                     |'),nl,
    write('|2-Nao                                                                                                     |'),nl,
    read(OPCEB),
...
continuacao28:-
    write('|                                                                                                          |'),nl,
    write('|Tem erupcoes cutaneas?                                                                                    |'),nl,
    write('|1-Sim                                                                                                     |'),nl,
    write('|2-Nao                                                                                                     |'),nl,
    read(OPEC),
...
continuacao50:-
    write('|                                                                                                          |'),nl,
    write('|Tem vermelhidao na zona das articulacoes?                                                                 |'),nl,
    write('|1-Sim                                                                                                     |'),nl,
    write('|2-Nao                                                                                                     |'),nl,
    read(OPVAO),
...
continuacao51:-
    write('|                                                                                                          |'),nl,
    write('|Tem inchaco nas articulacoes?                                                                             |'),nl,
    write('|1-Sim                                                                                                     |'),nl,
    write('|2-Nao                                                                                                     |'),nl,
    read(OPIAO),
...
continuacao53:-
    write('|                                                                                                          |'),nl,
    write('|Tem deformacao nas articulacoes?                                                                          |'),nl,
    write('|1-Sim                                                                                                     |'),nl,
    write('|2-Nao                                                                                                     |'),nl,
    read(OPDFAO),
...
continuacao57:-
    write('|                                                                                                          |'),nl,
    write('|Tem sensacao de corpo estranho?                                                                           |'),nl,
    write('|1-Sim                                                                                                     |'),nl,
    write('|2-Nao                                                                                                     |'),nl,
    read(OPSCEO),

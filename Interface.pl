...
continuacao12:-
    nl,
    write('|Tem sintomas de vómito?                                                                                             |'),nl,
    write('|1-Sim                                                                                                     |'),nl,
    write('|2-Não                                                                                                     |'),nl,
    read(OPV),
...
continuacao22:-
    nl,
    write('|Tem uma camada esbranquiçada na boca?                                                                         |'),nl,
    write('|1-Sim                                                                                                     |'),nl,
    write('|2-Não                                                                                                     |'),nl,
    read(OPCEB),
...
continuacao41:-
    nl,
    write('|Esses espirros são contantes?                                                                                   |'),nl,
    write('|1-Sim                                                                                                     |'),nl,
    write('|2-Não                                                                                                     |'),nl,
    read(OPECC),
...
continuacao42:-
    nl,
    write('|Tem sensibilidade à luz?                                                                                  |'),nl,
    write('|1-Sim                                                                                                     |'),nl,
    write('|2-Não                                                                                                     |'),nl,
    read(OPSL),
...
continuacao50:-
    nl,
    write('|Tem vermelhidão na zona das articulações?                                                                         |'),nl,
    write('|1-Sim                                                                                                     |'),nl,
    write('|2-Não                                                                                                     |'),nl,
    read(OPVAO),
...
continuacao56:-
    nl,
    write('|Tem sensação de areia nos olhos?                                                                                    |'),nl,
    write('|1-Sim                                                                                                     |'),nl,
    write('|2-Não                                                                                                     |'),nl,
    read(OPSAO),
...
continuacao57:-
    nl,
    write('|Tem sensação de corpo estranho?                                                                           |'),nl,
    write('|1-Sim                                                                                                     |'),nl,
    write('|2-Não                                                                                                     |'),nl,
    read(OPSCEO),

...
medicamento(zona, 6, comprimido, aciclovir, mais18anos, null, '800mg', null, '4a4horas', [alergiaAciclovir, gravidez, amamentacao, idosos]). % verificar com medico idosos criancas e bebes
...
medicamento(enxaqueca, 8, repouso, null, paragem, null, null, null, null, null).
